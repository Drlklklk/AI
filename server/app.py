...
def process_input():
    ...
    # Get the current timestamp and vectorize the user input
    timestamp = time()
    ...
    # Load the conversation and fetch memories
    conversation = load_convo()
    memories = fetch_memories(vector, conversation, 10)
    
    # Summarize the memories and compose a prompt for the AI
    ...
    # Generate a response and vectorize it
    ...
    # Return the AI response as a JSON object in the response
